...
BEGIN
    ...
    -- 1.1 Administrador Nacional
    INSERT INTO Usuario_Sistema (username, password_hash, email, rol_id, estado)
    VALUES ('admin.central', 'ADMIN123HASH', 'admin@wasimikuna.gob.pe', 1, 1)
    RETURNING usuario_id INTO v_user_admin_id;

    -- 1.2 Monitor Regional
    INSERT INTO Usuario_Sistema (username, password_hash, email, rol_id, estado)
    VALUES ('monitor.cusco', 'MONITOR123HASH', 'monitor.cusco@wasimikuna.gob.pe', 2, 1)
    RETURNING usuario_id INTO v_user_monitor_id;

    -- 1.3 Director de Colegio
    INSERT INTO Usuario_Sistema (username, password_hash, email, rol_id, estado)
    VALUES ('director.paucar', 'DIRECTOR123HASH', 'director.50421@minedu.gob.pe', 3, 1)
    RETURNING usuario_id INTO v_user_director_id;

    -- 1.4 Proveedor Agricultor
    INSERT INTO Usuario_Sistema (username, password_hash, email, rol_id, estado)
    VALUES ('agro.andina', 'PROVEEDOR123HASH', 'ventas@agroandina.com', 4, 1)
